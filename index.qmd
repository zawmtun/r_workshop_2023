...
The slides presented in the workshop can be downloaded from this [link](https://github.com/zawmtun/r_workshop_ex.git). Look for the green button \[code\] with a dropdown menu from which download the zip file. Then, unzip it on your computer.
