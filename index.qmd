...
We will need `tidyverse`, `broom`, `gtsummary`, `car`, and `patchwork` packages to follow the lessons. Once you open RStudio, you will see the R Console pane on the left-side of your screen.
...
```{r}
#| eval: false
install.packages(c("tidyverse", "broom", "gtsummary", "car", "patchwork"))
```
